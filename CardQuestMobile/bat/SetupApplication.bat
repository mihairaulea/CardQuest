...
:: Android packaging
set AND_CERT_NAME="CardQuest"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\CardQuest.p12
...
set IOS_PROVISION=cert\CardQuest.mobileprovision
...
set APP_ID=air.CardQuest

:: Output packages
set DIST_PATH=dist
set DIST_NAME=CardQuest
